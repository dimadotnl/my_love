...
const compliments = [
  ...
  "Рядом с тобой я чувствую себя по-настоящему дома, где бы мы ни находились.",
  "Ты делаешь меня лучше просто тем, что ты есть рядом.",
  "Ты всегда невероятна прекрасна", 
